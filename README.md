...
- No Css de maneira geral tive mais auxilio da IA, inicialmente acreditava que teria de criar um novo arquivo como criei para as outras páginas mas estudando vi que não seria necessário, a partir daí foi entender como acrescentar a formatação semelhante a primeira pagina nas próximas. Tenho certa experiencia com aplicativos de edição, então criei esboços em imagens para a IA me auxiliar em como eu deveria alterar o Css para o layout ficar adaptado da forma que eu queria, de maneira diferente do código usado como base e adaptando à pagina principal e em seguida trazendo as mudanças as paginas secundárias.
- Por último, precisava lançar esse HTML para rodar como site em alguma plataforma, escolhi a GITpages após ver alguns vídeos como fazer, porém tive um problema no link do site era mostrado o README do repositório, depois de muitas tentativas pedi auxilio a IA e fui orientado a criar a pasta .github onde nela há um código de direcionamento de qual arquivo o GITpages vai ler e levar para o site "hosteado" pela plataforma.
